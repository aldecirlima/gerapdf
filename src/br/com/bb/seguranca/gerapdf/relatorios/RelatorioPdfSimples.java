...
public class RelatorioPdfSimples implements Relatorio {
	...
	private String caminhoRelatorio = "C:\\JAVA\\pdf\\RelatorioSimples.pdf";
	...
	public void gerarCorpo() {
		...
		this.documentoPDF.add(new Paragraph(pItensVendidos));
		...
		pTotal.add(new Chunk("Total da venda: R$ " 
				+ this.venda.calcularValorTotalDoCarrinho(),
	...
	public void gerarRodape() {
		...
		pRodape.add(new Chunk("https://seguranca.bb.com.br", new Font(Font.TIMES_ROMAN, 14)));
